var NepaliFunctions = (function () {
	...
	function l() {
		...
		var r = { year: 1970, month: 1, day: 1 },
			a = { year: 2099, month: 12, day: 30 };
		function i(e) {
			var t = 0;
			return (
		...
		function u(t, n) {
			var r = 0,
				a = 0;
			for (a = t.year; a <= n.year; a += 1) r += i(e[a]);
			for (a = 0; a < t.month; a += 1) r -= e[t.year][a];
			for (r += e[t.year][11], a = n.month - 1; a < 12; a += 1) r -= e[n.year][a];
			return (r -= t.day + 1), (r += n.day - 1);
		}
		function l(e, t) {
			var n = new Date(f(e, d));
			return (
		...
		return (
			n == o &&
				...
				"[object Date]" === Object.prototype.toString.call(e) &&
					...
					(t = d))),
			(function (e) {
				return "object" == typeof e && e.year && e.month && e.day;
			})(e) || (e = p(e, (t = c(t) ? t : a))),
			{ dateObject: e, dateFormat: t }
		);
	}
	function c(t) {
	...
	function m(e, t, n) {
		var r = s(e, t, o);
		if (((e = r.dateObject), (t = r.dateFormat), !e)) return null;
		var a = new l().ad2bs(e);
		return t ? ((t = c(t) ? t : d), f(a, (n = c(n) ? n : u))) : a;
	}
	function h(e, t, n) {
		var r = s(e, t);
		if (((e = r.dateObject), (t = r.dateFormat), !e)) return null;
	...
	function f(t, n) {
		...
		switch ((n = n && e.indexOf(n) > -1 ? n : u)) {
			case "MM/DD/YYYY":
				r = a(t.month) + "/" + a(t.day) + "/" + t.year;
				break;
			case "MM-DD-YYYY":
				r = a(t.month) + "-" + a(t.day) + "-" + t.year;
				break;
			case "YYYY-MM-DD":
				r = t.year + "-" + a(t.month) + "-" + a(t.day);
				break;
			case "YYYY/MM/DD":
				r = t.year + "/" + a(t.month) + "/" + a(t.day);
				break;
			case "DD-MM-YYYY":
				r = a(t.day) + "-" + a(t.month) + "-" + t.year;
				break;
			case "DD/MM/YYYY":
				r = a(t.day) + "/" + a(t.month) + "/" + t.year;
		}
	...
	function v(e) {
		...
		var n = t.getUTCDate(),
			r = t.getUTCMonth() + 1,
			a = { year: t.getUTCFullYear(), month: r, day: n };
		return e ? f(a, (e = c(e) ? e : d)) : a;
	}
	function b(e) {
		return (
			(e = Number(e)),
	...
	function M(e, t, n, r) {
		var a = s(e, n);
		if (((e = a.dateObject), (n = a.dateFormat), !e)) return null;
		if (!(t = s(t, n).dateObject)) return null;
		var i = null,
			o = null;
		switch (
			(E(e) && E(t)
				? ((e = h(e)),
				  (t = h(t)),
				  (i = new Date(e.year, e.month - 1, e.day).getTime()),
				  (o = new Date(t.year, t.month - 1, t.day).getTime()))
				: ((i = 1e4 * e.year + 100 * e.month + e.day),
				  (o = 1e4 * t.year + 100 * t.month + t.day)),
			r)
		) {
			case "==":
				return i == o;
	...
	function T(e, t) {
		var n = new l(),
			r = n.minDate(),
			a = n.maxDate();
		return (e < r.year || e > a.year) && (t < r.month || t > r.month)
			? 0
	...
	function E(e, t) {
		var n = s(e, t);
		if (((e = n.dateObject), (t = n.dateFormat), !e)) return !1;
		var r = new l(),
			a = r.minDate(),
			i = r.maxDate(),
			o = e.day + 100 * e.month + 1e4 * e.year,
			u = a.day + 100 * a.month + 1e4 * a.year;
		if (o > i.day + 100 * i.month + 1e4 * i.year || o < u) return !1;
		var d = T(e.year, e.month);
		return e.month > 0 && e.month <= 12 && e.day > 0 && e.day <= d;
	}
	return {
		AvailableFormats: e,
		...
		NumberToWords: function (e, t) {
			...
			var o = Math.floor(e % 100),
				u = null;
			e.toString().length > 2 &&
				(u = e.toString().substring(e.toString().length - 3, e.toString().length - 2));
		...
		NumberToWordsUnicode: function (e, t) {
			...
			if (!(e.length > 13)) {
				var d = Math.floor(e % 100),
					l = "";
				e.toString().length > 2 &&
					(l = e.toString().substring(e.toString().length - 3, e.toString().length - 2));
				...
				h = (h = h.toString()).substring(0, h.length - 9);
				var f = Math.floor(e % 1e13);
				return (
					(f = (f = f.toString()).substring(0, f.length - 11)) > 0 &&
						(r += n[f] + " खरब"),
					h > 0 && (r += " " + n[h] + " अरब"),
					m > 0 && (r += " " + n[m] + " करोड"),
					c > 0 && (r += " " + n[c] + " लाख"),
		...
		AD: {
			...
			DatesDiff: function (e, t, n) {
				var r = s(e, n, o);
				return (
					(e = r.dateObject),
					(n = r.dateFormat),
					e && (t = s(t, n, o).dateObject) ? new l().countAdDays(e, t) : null
				);
			},
			AddDays: function (e, t, n) {
				...
				return (
					(e = r.dateObject),
					(n = r.dateFormat),
					(e = new Date(e.year, e.month - 1, e.day)).setDate(e.getDate() + t),
					(e = { year: e.getFullYear(), month: e.getMonth() + 1, day: e.getDate() }),
					n ? NepaliFunctions.ConvertToDateFormat(e, n) : e
				);
			},
			GetFullDate: function (e, t) {
				var n = s(e, t, o);
				return (
					(e = n.dateObject),
					(t = n.dateFormat),
					e ? `${e.day} ${NepaliFunctions.AD.GetMonth(e.month - 1)} ${e.year}` : null
				);
			},
			GetFullDay: function (e, t) {
				var n = s(e, t, o);
				return (
					(e = n.dateObject),
					(t = n.dateFormat),
					e ? b((e = new Date(e.year, e.month - 1, e.day)).getDay()) : null
				);
			},
		},
		BS: {
			ValidateDate: E,
			IsBetweenDates: function (e, t, n, r, a) {
				var i = s(e, r);
				if (((e = i.dateObject), (r = i.dateFormat), !e)) return null;
				var o = s(t, r);
				if (((t = o.dateObject), (r = o.dateFormat), !t)) return null;
				if (!(n = s(n, r).dateObject)) return null;
				if (!E(e) || !E(t) || !E(n)) return null;
				a = !0 === a;
				var u = h(e),
					l = h(t),
					c = h(n),
					...
					y = new Date(f(c, d)),
					v = !1;
				return a ? m >= p && m <= y && (v = !0) : m > p && m < y && (v = !0), v;
			},
			GetCurrentDate: F,
			GetCurrentYear: function () {
				var e = F();
			...
			GetFullDate: function (e, t, n) {
				var r = s(e, n);
				if (((e = r.dateObject), (n = r.dateFormat), !e)) return null;
				var a = [],
					i = "";
				return (
					t
						? ((a = [
						  ...
						  (i = `${y(e.day)} ${a[e.month - 1]} ${y(e.year)}`))
						: ((a = [
								"Baisakh",
								"Jestha",
								"Ashar",
			...
			GetFullDay: function (e, t) {
				var n = s(e, t);
				if (((e = n.dateObject), (t = n.dateFormat), !e)) return null;
				var r = NepaliFunctions.BS2AD(e);
				return b((r = new Date(r.year, r.month - 1, r.day)).getDay());
			},
			GetFullDayInUnicode: function (e, t) {
				var n = s(e, t);
				if (((e = n.dateObject), (t = n.dateFormat), !e)) return null;
				var r = NepaliFunctions.BS2AD(e);
				return Y((r = new Date(r.year, r.month - 1, r.day)).getDay());
			},
			GetDaysInMonth: T,
			DatesDiff: function (e, t, n) {
				var r = s(e, n);
				return (
					(e = r.dateObject),
					(n = r.dateFormat),
					e && (t = s(t, n).dateObject)
						? !(!E(e) || !E(t)) && ((e = h(e)), (t = h(t)), new l().countAdDays(e, t))
						: null
				);
			},
			AddDays: function (e, t, n) {
				var r = s(e, n);
				if (((e = r.dateObject), (n = r.dateFormat), !e)) return null;
				var a = NepaliFunctions.BS2AD(e);
				return (
					(a = new Date(a.year, a.month - 1, a.day)).setDate(a.getDate() + t),
					(a = { year: a.getFullYear(), month: a.getMonth() + 1, day: a.getDate() }),
					(e = NepaliFunctions.AD2BS(a)),
					n ? NepaliFunctions.ConvertToDateFormat(e, n) : e
				);
			},
			IsEqualTo: function (e, n, r) {
				return M(e, n, r, t);
			},
			IsGreaterThan: function (e, t, n) {
				return M(e, t, n, a);
			},
			IsLessThan: function (e, t, r) {
				return M(e, t, r, n);
			},
			IsGreaterThanOrEqualTo: function (e, t, n) {
				return M(e, t, n, i);
			},
			IsLessThanOrEqualTo: function (e, t, n) {
				return M(e, t, n, r);
			},
		},
	};
...
!(function () {
		...
		if (e) o();
			...
			!(function (e) {
				if (!document.getElementById("ndp-nepali-box")) {
					var t = m(e);
					document.querySelector(t.container).insertAdjacentElement("beforeend", p(t));
					var n = document.getElementById("ndp-nepali-box");
					n.addEventListener("mouseenter", a), n.addEventListener("mouseleave", i);
				}
			})(t),
				(n = m(t)),
				(r = t);
			...
			l
				...
				: ((s = NepaliFunctions.BS.GetCurrentDate()),
				  n.disableAfter &&
						NepaliFunctions.BS.IsGreaterThan(s, n.disableAfter) &&
						(s = n.disableAfter));
			var c = null;
			null == s
				? ((s = NepaliFunctions.BS.GetCurrentDate()), (c = ""))
				: (c = NepaliFunctions.ConvertToDateFormat(s, "YYYY-MM-DD")),
				d(s.year, s.month, c),
				(function (e) {
					var t = (function (e) {
							var t = m();
	...
	function d(e, t, n, r) {
		...
		var o = m(r),
			...
			h = i.getElementsByTagName("table")[0].getElementsByTagName("tbody");
		h.length > 0 && h[0].parentNode.removeChild(h[0]);
		var f = o.ndpYearCount || 0,
		...
		v.innerHTML = u
			? NepaliFunctions.BS.GetMonth(t - 1)
			: NepaliFunctions.BS.GetMonthInUnicode(t - 1);
		var b = document.createElement("SPAN");
		(b.innerHTML = u ? e : NepaliFunctions.ConvertToUnicode(e)),
			o.ndpMonth && o.ndpYear
				? (p.appendChild(s(t, e, n, r)), p.appendChild(c(t, e, f, n, r)))
				: o.ndpMonth
				? (p.appendChild(s(t, e, n, r)), p.appendChild(y), p.appendChild(b))
				: o.ndpYear
				? (p.appendChild(v), p.appendChild(y), p.appendChild(c(t, e, f, n, r)))
		...
		var D = (function (e, t) {
			...
			F = g.year,
			Y = g.month,
			A = document.getElementById("ndp-header" + a),
			T = document.getElementById("prev" + a);
		T && T.parentNode.removeChild(T);
		var B = document.getElementById("next" + a);
		...
		o.disableBefore &&
			NepaliFunctions.BS.IsGreaterThan(o.disableBefore, {
				year: F,
				month: Y,
				day: NepaliFunctions.BS.GetDaysInMonth(F, Y),
			}) &&
			(C = !1);
		var S = document.createElement("SPAN");
		S.setAttribute("class", "ndc-chevron ndc-left");
		var E = document.createElement("A");
		E.setAttribute("id", "prev" + a),
			E.setAttribute("title", "Previous Month"),
			E.setAttribute("class", C ? "ndp-prev" : "ndp-prev ndp-disabled"),
		...
		var I = !0;
		o.disableAfter &&
			NepaliFunctions.BS.IsGreaterThan({ year: N, month: M, day: 1 }, o.disableAfter) &&
			(I = !1);
		var O = document.createElement("SPAN");
		O.setAttribute("class", "ndc-chevron ndc-right");
		var j = document.createElement("A");
		j.setAttribute("id", "next" + a),
			j.setAttribute("title", "Next Month"),
			j.setAttribute("class", I ? "ndp-next" : "ndp-next ndp-disabled"),
			...
			i.getElementsByTagName("table")[0].insertAdjacentElement(
				...
				(function (e, t, n, r) {
					...
					var c = NepaliFunctions.BS.GetCurrentDate(),
						h = c.year,
						f = c.month,
						p = c.day,
						y = NepaliFunctions.BS.GetDaysInMonth(e, t),
						v = { year: e, month: t, day: 1 },
						b = NepaliFunctions.BS2AD(v),
						D = b.year,
						g = b.month,
						N = b.day,
						M = new Date(D, g - 1, N).getDay(),
						F = 0,
						Y = 0,
						A = M + y,
						T = "",
					...
					!u.disableBefore &&
						...
						(u.disableBefore = NepaliFunctions.BS.AddDays(
					...
					!u.disableAfter &&
						...
						(u.disableAfter = NepaliFunctions.BS.AddDays(
							NepaliFunctions.BS.GetCurrentDate(),
					...
					for (; Y < A; ) {
						if (
							((F = Y) % 7 == 0 && (E = document.createElement("TR")),
							(C = F - M + 1),
							(B =
								e.toString() +
								"-" +
							...
							(T =
								e === a && t === i && C === o
									...
									? "ndp-current"
									: "ndp-date"),
							u.isDiv && !u.onDateClick && (T += " ndp-link-disabled"),
							F < M)
						)
							(I = document.createElement("TD")), E.appendChild(I);
						else {
							if (
								((I = document.createElement("TD")).setAttribute("class", T),
								(u.disableAfter &&
									NepaliFunctions.BS.IsGreaterThan(
										NepaliFunctions.ConvertToDateObject(B, "YYYY-MM-DD"),
										u.disableAfter
									)) ||
									(u.disableBefore &&
										NepaliFunctions.BS.IsGreaterThan(
									...
									u.disableDates.indexOf(
										NepaliFunctions.ConvertToDateFormat(
											NepaliFunctions.ConvertToDateObject(B, "YYYY-MM-DD"),
											u.dateFormat
										)
									) > -1)
							)
								(O = document.createElement("A")).setAttribute(
									"class",
									"ndp-disabled"
								),
									O.setAttribute("href", "javascript:void(0)"),
									O.setAttribute("title", B),
									(O.innerHTML = d ? C : NepaliFunctions.ConvertToUnicode(C)),
									I.appendChild(O);
							else {
								var j = NepaliFunctions.ConvertToDateObject(B, "YYYY-MM-DD"),
									G = NepaliFunctions.ConvertToDateFormat(j, u.dateFormat);
								(O = document.createElement("A")).setAttribute(
									"href",
									"javascript:void(0)"
								),
									O.setAttribute("title", B),
									O.setAttribute("data-value", G),
									(O.innerHTML = d ? C : NepaliFunctions.ConvertToUnicode(C)),
									u.isDiv && u.isDiv
										? u.onDateClick &&
										  O.addEventListener("click", function () {
												...
												u.onDateClick({
													bs: NepaliFunctions.ConvertToDateFormat(
														t,
														"YYYY-MM-DD"
													),
													ad: NepaliFunctions.ConvertToDateFormat(
						...
						F % 7 == 6 && (S.appendChild(E), (E = document.createElement("TR"))),
							(Y += 1);
					}
					E.children.length > 0 && S.appendChild(E);
					return S;
				})(e, t, n, r)
			);
	}
		...
		if (!n.isDiv) {
			...
			n.ndpEnglishInput &&
				(document.getElementById(n.ndpEnglishInput).value =
					NepaliFunctions.ConvertToDateFormat(NepaliFunctions.BS2AD(a), n.dateFormat)),
	...
	function s(e, t, n, r) {
		...
		var s = o ? NepaliFunctions.BS.GetMonths() : NepaliFunctions.BS.GetMonthsInUnicode(),
			...
			c.addEventListener("change", function () {
				!(function (e, t, n) {
					...
					e = a.ndpYear
						...
						: e;
					var i = parseInt(document.getElementById("ndp-month-select" + r).value);
					d(e, i, t, n);
				})(t, n, r);
			}),
			c
	...
	function c(e, t, n, r, a) {
		...
		for (
			...
			p.setAttribute("value", h),
				(p.innerHTML = u ? h : NepaliFunctions.ConvertToUnicode(h)),
				t == h && p.setAttribute("selected", "selected"),
				c.appendChild(p),
				(h += 1);
		}
		return (
	...
	function m(e) {
		...
		if ((e || (e = r), e)) {
			...
			Number.isInteger(d) &&
				d >= 0 &&
				(o = NepaliFunctions.BS.AddDays(NepaliFunctions.BS.GetCurrentDate(), -1 * d)),
				Number.isInteger(l) &&
					l >= 0 &&
					(u = NepaliFunctions.BS.AddDays(NepaliFunctions.BS.GetCurrentDate(), l));
			var s = [];
			(a.disableDates = Array.isArray(a.disableDates) ? a.disableDates : []),
				a.disableDates.forEach((e) => {
					NepaliFunctions.BS.ValidateDate(e, i) && s.push(e);
				}),
				a &&
					(t = {
	...
	function f() {
		if (document.activeElement.classList.contains("ndp-nepali-calendar")) {
			var e = window.event || arguments.callee.caller.arguments[0];
			(27 != e.which && 9 != e.which) || (o(e.which), e.stopPropagation());
		}
	}
	function p(e) {
		var t = "english" == e.language,
			...
			r = "";
		e.isDiv
			? ((r = "-" + e.id), n.setAttribute("class", "ndp-nepali-box ndp-corner-all"))
			: (n.setAttribute("id", "ndp-nepali-box"), n.setAttribute("class", "ndp-corner-all")),
	...
	(Object.prototype.nepaliDatePicker = function (l) {
		...
		if ("remove" != l) {
			if (((l = void 0 === l ? {} : l), s.length && s.length > 0))
				for (y = 0; y < s.length; y++) D(s[y], l);
			else D(s, l);
			var c = document.querySelectorAll(".ndp-nepali-calendar");
			if (c.length > 0)
				for (y = 0; y < c.length; y++)
					c[y].addEventListener("mouseenter", a), c[y].addEventListener("mouseleave", i);
			window.addEventListener("mouseup", function () {
				N() && ("ndp-click-trigger" == document.activeElement.getAttribute("id") || b());
			});
			var m = !1;
		} else if (s.length && s.length > 0) for (var y = 0; y < s.length; y++) v(s[y]);
		else v(s);
		function v(e) {
			if ("INPUT" == e.tagName) {
		...
		function b() {
			...
			("BODY" == a.tagName || u || d) && (i = !0), e && ((!t && !l) || (t && !i)) && o();
		}
		function D(e, t) {
			var r = (function (e) {
			...
			if (
				...
				if (
					(t.ndpTriggerButton || e.addEventListener("focus", h),
				...
				var y = p(t);
				e.appendChild(y);
				var v = NepaliFunctions.BS.GetCurrentDate(),
					D = v.year,
					M = v.month;
				if (t.disableBefore || t.disableAfter) {
					var F = null;
					t.disableAfter &&
						((F = NepaliFunctions.ConvertToDateObject(
							t.disableAfter,
							t.dateFormat || "YYYY-MM-DD"
						)),
						NepaliFunctions.BS.IsGreaterThan(F, v) || ((D = F.year), (M = F.month)));
				}
				d(D, M, "", t.id);
			}
		}
