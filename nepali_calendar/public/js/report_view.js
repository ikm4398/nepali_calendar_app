...
// // Check if dependencies are available (keep error logs)
// if (!window.adToBs) {
...
// 					cell.html = window.ReportFormatFormDatetime(cell.content);
// 				} else {
// 					cell.html = window.ReportFormatFormDate(cell.content);
// 				}
...
// // Extend QueryReport (minimal override)
